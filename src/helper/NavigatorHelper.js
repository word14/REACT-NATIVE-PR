...
const headerLeft      = navigation => (
  <TouchableOpacity style={defaultHeaderLeftViewStyle} activeOpacity={0.85} onPress={() => navigation?.goBack()}>
    {/* <Icon name="chevron-left" size={36}/> */}
    <Image style={arrowStyle} source={arrowLeftIcon} resizeMode="contain" />
  </TouchableOpacity>
);
...
export const createBottomTabBarItem   = (options = {
  ...
  tabBarLabel   : ({ focused }) => 
    <Text style={focused ? defaultBottomTabBarActiveLabelStyle : defaultBottomTabBarLabelStyle}>{options.label}</Text>
});